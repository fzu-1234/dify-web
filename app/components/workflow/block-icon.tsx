...
const ICON_CONTAINER_BG_COLOR_MAP: Record<string, string> = {
  ...
  [BlockEnum.KnowledgeRetrieval]: 'bg-util-colors-cyan-cyan-500 ',
  [BlockEnum.QuestionClassifier]: 'bg-util-colors-cyan-cyan-500 ',
  [BlockEnum.TemplateTransform]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.VariableAssigner]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.VariableAggregator]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.Assigner]: 'bg-util-colors-indigo-indigo-500',
