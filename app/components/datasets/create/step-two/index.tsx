          ...
          {!isModelAndRetrievalConfigDisabled
            ? (
              <div className={'mb-1'}>
                ...
                {/* <div className='body-xs-regular text-text-tertiary hidden'>
                  <a target='_blank' rel='noopener noreferrer' href='https://docs.dify.ai/guides/knowledge-base/create-knowledge-and-upload-documents#id-4-retrieval-settings' className='text-text-accent hidden'>{t('datasetSettings.form.retrievalSetting.learnMore')}</a>
