const translation = {
  ...
  exportFailed: '导出文件失败',
  importDSL: '导入文件',
  createFromConfigFile: '通过文件创建',
  importFromDSL: '导入文件',
  importFromDSLFile: '文件',
  importFromDSLUrl: 'URL',
  importFromDSLUrlPlaceholder: '输入文件的 URL',
  ...
  newApp: {
    ...
    appCreated: '应用已创建',
    caution: '注意',
    appCreateDSLWarning: '注意：外部格式文件导入，可能无法正常运行',
    appCreateDSLErrorTitle: '版本不兼容',
    appCreateDSLErrorPart1: '外部格式文件导入，可能无法正常运行。',
    appCreateDSLErrorPart2: '是否继续导入？',
